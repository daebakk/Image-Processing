...
def main():
    ...
    # 참고
    # Opencv에 있는 내장 함수를 사용해도 같은 잘못된 결과가 나옴
    sob_x = cv2.Sobel(src,cv2.CV_64F,1,0,ksize=3)
    sob_y = cv2.Sobel(src, cv2.CV_64F, 0, 1, ksize=3)
    cv2.imshow('sob_x',sob_x/255)
    cv2.imshow('sob_y', sob_y/ 255)
